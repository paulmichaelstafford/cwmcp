...
def download_publication_chapters(client: CwbeClient, publication_id: str, output_dir: str) -> dict:
    """Download all chapters for a publication to a local directory.

    Returns: {"total": N, "downloaded": N, "skipped": N, "failed": N, "details": [...]}
    """
    ...
    for ch in chapters:
        ...
        try:
            download_url = client.get_chapter_download_url(publication_id, ch_id)
            import requests
